...
gsa_script_path <- "/Users/daniel/Documents/GitHub/WMed_EwE/scripts/medits_example_westmed.R"
custom_script_path <- "/Users/daniel/Documents/GitHub/WMed_EwE/scripts/medits_example_custom.R"
...
2. **Survey-specific example scripts** that read a particular survey's raw files, reshape them into the library's standardized input format, and call the shared functions. Two examples are covered here:
   - `medits_example_westmed.R` - MEDITS bottom-trawl data, study area defined by the official GFCM GSA (Geographical Sub-Area) polygons.
   - `medits_example_custom.R` - the same MEDITS data, but with the study area defined by a custom boundary (a simple bounding box, or any other shapefile) instead of GSA polygons - useful when the same underlying survey needs to support a different EwE model with its own footprint.
...
#| out-width: "100%"
safe_include_graphics(file.path("figures", "survey_sample_coverage_map.png"), "medits_example_westmed.R")
```
...
#| out-width: "100%"
safe_include_graphics(file.path("figures", "custom_survey_sample_coverage_map.png"), "medits_example_custom.R")
```
...
#| out-width: "100%"
safe_include_graphics(file.path("figures", "survey_fg_density_timeseries.png"), "medits_example_westmed.R")
```
...
#| out-width: "100%"
safe_include_graphics(file.path("figures", "survey_fg_density_timeseries_regional.png"), "medits_example_westmed.R")
```
...
#| out-width: "100%"
safe_include_graphics(file.path("figures", "survey_fg_depth_strata_profile.png"), "medits_example_westmed.R")
```
...
#| out-width: "100%"
#| fig-width: 16
safe_include_graphics(file.path("figures", "survey_sample_coverage_map_by_year.png"), "medits_example_westmed.R")
```
