...
## 02_fao_catches.R and 03_pbqb-traits.R both REQUIRE this to have run
...
if (!exists("FILTER_AREAS",  envir = .GlobalEnv, inherits = FALSE)) FILTER_AREAS  <- 1:11        # GSA
...
message("[01_survey_density] Region/year config in effect: FILTER_AREAS = ", paste(FILTER_AREAS, collapse=","),
