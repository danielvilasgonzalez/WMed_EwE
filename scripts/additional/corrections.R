...
# also error when commercial is in the name could bring missmatch, add to non commercial, example decapods)
# also if matched by multiple groups
# scaphopoda
# phylum usually wrong
# add seaweeds - rhodophyta, Chlorophyta, Ectoprocta, Brachipoda
# jellyfish usually wrong
